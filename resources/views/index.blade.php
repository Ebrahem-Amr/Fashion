                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-12">
                                    <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                        ...
                                        <p>Little Fashion templates comes with <a href="/sign-in">sign in</a> / <a href="/sign-up">sign up</a> pages, product listing / product detail, about, FAQs, and contact page.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-12">
                                    <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                        ...
                                        <div class="mt-2 mt-lg-auto">
                                            <a href="/contact" class="custom-link mb-2">
                                                Work with us
                                                <i class="bi-arrow-right ms-2"></i>
                                            </a>
                                        </div>
